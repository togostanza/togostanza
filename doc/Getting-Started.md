...
To control the style of the stanza, edit `style.scss`. The file is written in SCSS, which is a superset of CSS. This means essentially all valid CSS is also valid as SCSS. See [Sass: Syntax](https://sass-lang.com/documentation/syntax) for defails. The SCSS generated by default is as follows:
